function [spOut, vOut] = LSOmodelALkIF(spEx, spIn, DT, Iext)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Active Leaky Integrate-and-fire Model of LSO (with Voltage Reset at Spiking)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t = 1:Nsteps-1
 ...
 itot = iLL + iKL + iEx + iIn + jext(t); % total current 
