function [spOut, vOut] = LSOmodelPExIF(spEx, spIn, DT, Iext)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Passive Exponential Integrate-and-fire Model of LSO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
VT = -46.6; % [mV] soft spike threshold 
...
for t = 1:Nsteps-1
 ...
 itot = iLL + iSG + iEx + iIn + jext(t); % total current 
